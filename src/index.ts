 ...
 *     interface exposed from the peer.
 */
export let newChromeExtensionRpcSession:<T extends RpcCompatible<T> = Empty>
 ...
 */
export let newChromeExtensionRpcBackgroundService:<T extends RpcCompatible<T> = Empty>
